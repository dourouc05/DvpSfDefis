...
<h1>Éditer ma présentation</h1>
	<form method="post" action="<?php echo url_for('@myPresentation'); ?>">
		<table>
			<tr>
				<td colspan="2">
					<label for="presentation_title">Le titre de votre candidature</label> : 
					<input size="50" type="text" name="presentation_title" id="presentation_title" value="<?php echo $title; ?>"/>
				</td>
			</tr>
			<tr>
				<td style="width: 50px; " colspan="2">
					<a href="<?php echo $forum; ?>">La discussion sur le forum</a><label for="presentation_forum">Lien vers la discussion forum</label>
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<textarea rows="15" cols="500" name="presentation_description" id="presentation_description"><?php echo $descf; ?></textarea>
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<textarea rows="15" cols="200" name="presentation_shortdescription" id="presentation_shortdescription"><?php echo $sdesc; ?></textarea>
				</td>
			</tr>
		</table>
